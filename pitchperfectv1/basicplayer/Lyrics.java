...
public class Lyrics {
    ...
    //Reads lyrics from MIDI sequence assuming text to be in given charset. Creates vector of syllables
    public static Vector read(Sequence seq) throws IOException, UnsupportedEncodingException {
        long startTime = System.currentTimeMillis();
        if (charsetAutodetection) {
            System.out.println("====CHARACTER AUTODETECTION=====");
    ...
    private static String findCharset(Sequence seq) {
        ...
        if (!found) {
            ...
            // Most probable charset, first one is first guess etc... so the  last one  is the best choice
